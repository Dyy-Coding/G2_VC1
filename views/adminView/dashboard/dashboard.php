          ...
          <div class="row align-items-center">
            <div class="col-8">
              <div class="numbers">
                ...
                <p class="mb-0">
                <span class="text-success text-sm font-weight-bolder"><?= "+" . $totalPurchaseorders ?></span>  Purchaseorders
            ...
            <div class="row">
                <div class="col-8">
                    <div class="numbers">
                        ...
                        <p class="mb-0">
                            <span class="text-success text-sm font-weight-bolder">
                                <?php echo $data['percentageChange']; ?>%
          ...
          <div class="card z-index-2 h-100">
              <div class="card-header pb-0 pt-3 bg-transparent">
                  ...
                  <p class="text-sm mb-0">
                      ...
                      <span class="font-weight-bold"><?php echo $percentageChangesales; ?>% more</span> in <?php echo date('Y'); ?>
                  </p>
              </div>
              <div class="card-body p-3">
                  <div class="chart">
