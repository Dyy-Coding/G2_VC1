        ...
        <div class="col-8">
          <div class="numbers">
            ...
            <h5 class="font-weight-bolder">
              $<?php echo number_format((float)$today_money, 2); ?> <!-- Convert to float -->
            </h5>
            <p class="mb-0">
              <?php 
      ...
      <div class="row align-items-center">
        <div class="col-8">
          <div class="numbers">
            ...
            <h5 class="font-weight-bolder">
              <?php echo number_format((float)$total_customers_today); ?> <!-- Convert to float -->
            </h5>
            <p class="mb-0">
      ...
      <div class="row align-items-center">
        <div class="col-8">
          <div class="numbers">
            ...
            <h5 class="font-weight-bolder">
              $<?php echo number_format((float)$totalSalesAmount, 2); ?> <!-- Convert to float -->
            </h5>
            <p class="mb-0">
              ...
              <tr>
                ...
                <td class="text-center">
                  <?php 
                    ...
                    if ($stockQuantity <= 0) {
                      $status = 'Out of Stock';
                      $color = 'danger'; // Red for out of stock
                    } elseif ($stockQuantity <= 5) {
                      $status = 'Low Stock';
                      $color = 'warning'; // Yellow for low stock
                    } else {
                      $status = 'In Stock';
                      $color = 'success'; // Green for in stock
                    }
                  ?>
