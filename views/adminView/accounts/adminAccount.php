    ...
    <div class="card shadow border-0 rounded-4 overflow-hidden">
        <div class="row g-0">
            <div class="col-md-4 bg-primary text-white text-center p-4 d-flex flex-column align-items-center">
                ...
                ?>" alt="Profile Picture" class="rounded-circle border mb-3" style="width: 120px; height: 120px; object-fit: cover;">
                <h2 class="h5 fw-bold">
                    <?php echo htmlspecialchars($admin['first_name'] ?? 'Unknown'); ?>
                </h2>
                <p class="text-light"><i class="fas fa-shield-alt"></i> <?php echo htmlspecialchars($admin['role_name'] ?? 'Admin'); ?></p>
                <div class="mt-3">
                    <p><i class="fas fa-phone"></i> <?php echo htmlspecialchars($admin['phone'] ?? 'Not Provided'); ?></p>
                    <p><i class="fas fa-envelope"></i> <?php echo htmlspecialchars($admin['email'] ?? 'Not Provided'); ?></p>
                </div>
            ...
            <div class="col-md-8 p-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <p class="text-muted"><?php echo htmlspecialchars($admin['first_name'] ?? 'Not Provided'); ?></p>
                    </div>
                    <div class="col-md-6">
                ...
                <p class="text-muted"><?php echo htmlspecialchars(($admin['address'] ?? '') . ' ' . ($admin['street_address'] ?? '')) ?: 'Not Provided'; ?></p>
                <p class="fw-bold mb-1 mt-3">Role Description</p>
                <p class="text-muted"><?php echo htmlspecialchars($admin['role_description'] ?? 'Has full access to the system, can manage all data.'); ?></p>
                <div class="row mt-3">
                    <div class="col-md-6">
                        <p class="fw-bold mb-1">Created At</p>
                        <p class="text-muted"><?php echo htmlspecialchars($admin['created_at'] ?? 'Not Provided'); ?></p>
                    </div>
                    <div class="col-md-6">
                        <p class="fw-bold mb-1">Updated At</p>
                        <p class="text-muted"><?php echo htmlspecialchars($admin['updated_at'] ?? 'Not Provided'); ?></p>
                    </div>
                </div>
            </div>
        </div>
